  ...
  .then((client) => {
    ...
    app.post("/api/login", async (req, res) => {
      ...
      try {
        ...
        await database
          .collection("gebruikers")
          .updateOne({ email }, { $set: { accesstoken: _bearer } });
    ...
    app.get("/api/docenten", async (req, res) => {
      log.info(
        { endpoint: "/api/docenten", query: req.query },
        "GET request docenten received"
      );
      const query =
        "naam" in req.query ? { naam: new RegExp(req.query.naam, "i") } : {};
    ...
    app.get("/api/docenten/:id", async (req, res) => {
      ...
      log.info(
        { endpoint: "/api/docenten/:id", query: query },
        "GET request docent received"
      );
    ...
    app.get("/api/docenten", async (req, res) => {
      ...
      const sort = "sort" in req.query ? { naam: 1 } : {};
      log.info(
        { endpoint: "/api/docenten", query: query },
        "GET request docent sort received"
      );
      const results = await database
        .collection("docenten")
        .find(query)
    ...
    app.post("/api/docenten", async (req, res) => {
      log.info(
        { endpoint: "/api/docenten", body: req.body },
        "POST request docent received"
      );
...
app.patch("/api/docenten/:id", async (req, res) => {
  try {
    ...
    app.delete("/api/docenten/:id", async (req, res) => {
      try {
        ...
        log.error(
          ...
          "Error in DELETE request docent"
        );
        return res
          .status(500)
          .json({ error: "An error occurred during DELETE request" });
      }
    });
    ...
    app.get("/api/vakken", async (req, res) => {
      //logging
      log.info(
        { endpoint: "/api/vakken", query: req.query },
        "GET request vakken received"
      );
      const query =
        "naam" in req.query ? { naam: new RegExp(req.query.naam, "i") } : {};
      const sort = "sort" in req.query ? { naam: 1 } : {};
    ...
    app.get("/api/vakken/:id", async (req, res) => {
      ...
      //logging
      log.info(
        { endpoint: "/api/vakken/:id", query: query },
        "GET request vak received"
      );
      console.log(query);
    ...
    app.get("/api/klassen", async (req, res) => {
      //logging
      log.info(
        { endpoint: "/api/klassen", query: req.query },
        "GET request klassen received"
      );
      const query =
        "naam" in req.query ? { naam: new RegExp(req.query.naam, "i") } : {};
      const sort = "sort" in req.query ? { naam: 1 } : {};
    ...
    app.get("/api/klassen/:id", async (req, res) => {
      ...
      //logging
      log.info(
        { endpoint: "/api/klassen/:id", query: query },
        "GET request klas received"
      );
      console.log(query);
